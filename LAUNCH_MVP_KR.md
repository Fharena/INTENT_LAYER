...
2. docs
3. landing README
4. install guide: local tarball install, `/vite` wrapper export smoke, 설치된 plugin transform/graph smoke, 실제 Vite dev server HTTP preview/apply, apply refresh, 3-file graph refresh smoke는 구현됨, public package 이름/문구는 남음
