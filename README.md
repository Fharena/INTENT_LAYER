...
- related source snapshot/diff and semantic token diff output for simple variable-reference read-only handoff, including simple `cn()` / `clsx()` variable declarations
