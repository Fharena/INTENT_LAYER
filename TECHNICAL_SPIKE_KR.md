...
2. external npm package import와 cross-file/transitive variable data flow에 대한 agent handoff 문맥을 보강한다.
...
아직 external npm package import, variant 함수 의미, cross-file/transitive variable data flow까지 자동 분석하지는 않는다.
