...
export function AiShadcn08({ selected = false, muted = false }: { selected?: boolean; muted?: boolean }) {
  return (
    <article className={cn("rounded-xl border border-neutral-200 bg-white p-6 shadow-sm", selected && "ring-2 ring-cyan-300")}>
      <header className="flex items-start justify-between gap-4">
        <div className="flex flex-col gap-2">
          <h2 className="text-lg font-semibold text-neutral-950">Generated card 8</h2>
