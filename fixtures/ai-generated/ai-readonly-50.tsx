...
function AiReadonly50Variants(tone: "primary" | "ghost") {
  return tone === "primary" ? "bg-lime-700 text-white" : "bg-gray-100 text-gray-800";
}

export function AiReadonly50({ featured = false }: { featured?: boolean }) {
  ...
  return (
    <section className={shellClass}>
      <div className="flex flex-col gap-4 rounded-xl bg-gray-50 p-5">
        ...
        <button className={AiReadonly50Variants("primary")}>Variant action</button>
