...
// Source label: ai-landing-12

export function AiLanding12() {
  return (
    <main className="min-h-screen bg-zinc-950 px-8 py-10 text-white">
      <section className="mx-auto flex max-w-5xl flex-col gap-8 rounded-3xl border border-white/10 bg-white/10 p-8 shadow-xl">
        <p className="text-sm font-semibold uppercase tracking-wide text-sky-200">Launch sample 12</p>
        ...
        <div className="flex flex-wrap gap-3">
          <a className="rounded-lg bg-sky-400 px-5 py-3 text-sm font-semibold text-zinc-950">Start</a>
